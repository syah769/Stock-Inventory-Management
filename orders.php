	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    <label for="category" class="col-sm-2 control-label">Types of Store</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="category" name="category" placeholder="Store" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->		
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label">SST 6%</label>
				    <div class="col-sm-9">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
  			...
  			$sql = "SELECT orders.order_id, orders.order_date, orders.client_name, orders.client_contact, orders.category, orders.sub_total, orders.vat, orders.total_amount, orders.discount, orders.grand_total, orders.paid, orders.due, orders.payment_type, orders.payment_status FROM orders 	
			  ...
			  <div class="form-group">
			   ...
			   <div class="form-group">
			    <label for="category" class="col-sm-2 control-label">Types of Store</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="category" name="category" placeholder="Store" autocomplete="off" value="<?php echo $data[3] ?>" />
			    </div>
			  </div> <!--/form-group-->			  
